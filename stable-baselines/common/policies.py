...
class BaseModel(nn.Module):
    ...
    def __init__(
        ...
        if normalize_images is False and issubclass(features_extractor_class, (NatureCNN, CustomCNN, CustomCNN2, CombinedExtractor)):
...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        if net_arch is None:
            if features_extractor_class == NatureCNN or features_extractor_class == CustomCNN:
                net_arch = []
            else:
...
class ActorCriticCustomCnnPolicy(ActorCriticPolicy):
    """
    CNN policy class for actor-critic algorithms (has both policy and value prediction).
    Used by A2C, PPO and the likes.
...
class ActorCriticCustomCnn2Policy(ActorCriticPolicy):
    """
    CNN policy class for actor-critic algorithms (has both policy and value prediction).
    Used by A2C, PPO and the likes.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        squash_output: bool = False,
        features_extractor_class: Type[BaseFeaturesExtractor] = CustomCNN2,
        features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        share_features_extractor: bool = True,
        normalize_images: bool = True,
        optimizer_class: Type[th.optim.Optimizer] = th.optim.Adam,
